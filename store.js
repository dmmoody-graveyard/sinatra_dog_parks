var parks = [
   ...
   },
   {
      ...
      waterAvailable: "Yes",
      size: "1.41 acres",
      description: "The Fields in the Pearl District is an off-leash sanctuary for those city dwellars living in its vicinity. The park itself is a work in progress, with final completion set for sometime in mid-2010. As such, the off-leash area is currently designated as temporary, but the final park will also possess an off-leash area in some form. The current park provides a no-frills, flat grassy off-leash area large enough for a good game of fetch. There are some doggie play structures, benches for humans, water, dog bag stations, and nice views of the surrounding city. The park is not fenced and due to its adjacency to city streets and some nearby railroad tracks, keep a good eye on your pooch."
   },
   {
      id: 18,
